  ...
  <aside class="w-64 bg-white border-r border-gray-200 h-screen fixed left-0 top-0 flex flex-col z-10">
    ...
    <div class="p-4 border-t border-gray-200">
      ...
      <button 
        ...
        class="mt-2 w-full text-sm text-red-600 hover:text-red-700 hover:bg-red-50 py-2 rounded-lg transition-colors flex items-center justify-center"
      >
        ...
        <header class="flex justify-between items-center mb-8">
          ...
          <div class="flex items-center space-x-4">
            ...
            <div class="flex items-center space-x-2">
              ...
              <div class="text-sm">
                <p class="font-medium text-gray-700" id="userName">Loading...</p>
              </div>
            </div>
          </div>
        </header>
