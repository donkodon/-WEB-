...
(function() {
    ...
    window.switchTab = function(tab) {
        window.logger && window.logger.debug('🔄 switchTab called with:', tab);
        ...
        if (tab === 'adjust') {
            window.logger && window.logger.debug('📋 Switching to adjust tab');
            ...
            if (window.switchToOriginalForMask) {
                window.switchToOriginalForMask(function() {
                    ...
                    if (window.showMaskOverlay) {
                        ...
                        window.logger && window.logger.error('❌ window.showMaskOverlay is not defined!');
                    }
                });
            } else {
                window.logger && window.logger.error('❌ window.switchToOriginalForMask is not defined!');
            }
        }
    };
